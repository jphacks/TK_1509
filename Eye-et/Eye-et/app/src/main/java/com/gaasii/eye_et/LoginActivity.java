...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     * the user.
     */
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> implements HttpPostListener{
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                task.addText("email", mEmail);
                task.addText("password", mPassword);
                task.setListener(UserLoginTask.this);
                task.execute();
    ...
    protected void goNextScene(String mEmail){
